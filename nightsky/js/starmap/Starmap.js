...
var Starmap = (function () {
    function Starmap(j$, containerId) {
        this.now = {};
    ...
    Starmap.prototype.refresh = function () {
        var canvas = document.getElementById(this.containertId);
    ...
    Starmap.prototype.init_stars = function (star) {
        var clut = [
            "#AEC1FF",
            "#C5D3FF",
            "#EAEDFF",
    ...
    Starmap.prototype.init_planets = function (planet) {
