...
var constellationColor = "#d8d8d8";
var starNameColor = "#d8d8d8";
var bgcolor;
var containertId = "";
...
function setConstellationColor(value){
    constellationColor = value;
}
function setStarNameColor(value){
    starNameColor = value;
}
...
function draw_sky( context, w, h )
{
    ...
    context.fillStyle = starNameColor;
    ...
    if ( ck_conlines ) {
        ...
        context.strokeStyle = constellationColor;
        len = conline.length;
        for ( i = 0; i < len; i++ )
...
function refresh()
{
    var canvas = document.getElementById( containertId );
